  ...
  <footer>
    ...
    <section class="contact">
      ...
      <div class="content-form">
        <div class="form">
          <form action="formulaire" id="formulaire" method="POST">
            <input type="text" id="first-name" name="user_firstname" placeholder="Prénom">
            <input type="text" id="last-name" name="user_lastName" placeholder="Nom">
            <input type="email" id="email" name="user_email" placeholder="Email">
            <input type="number" id="number" name="user_number" placeholder="Numéro">
            ...
            <textarea name="message" id="message" name="user_message" placeholder="Message..." cols="30" rows="10"></textarea>
        ...
        <div class="info">
          ...
          <div class="reseaux">
            <div class="circle-logo">
              <img src="assets/images/logo-insta.png" width="28px">
            </div>
            <div class="circle-logo">
              <img src="assets/images/logo-tiktok.png" width="23px">
            </div>
            <div class="circle-logo">
              <img src="assets/images/logo-twitter.png" width="30px">
            </div>
            <div class="circle-logo">
              <img src="assets/images/logo-youtube.png" width="33px">
            </div>
            <div class="circle-logo">
              <img src="assets/images/logo-fb.png" width="15px">
            </div>
          </div>
        </div>
      </div>
